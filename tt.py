...
class text:
        thanchu = "안녕하세요 틱톡팀입니다. 이 계정은 TikTok에 적 합하지 않습니다. 이 아이는 내 아이입니다. 나 는 아기 의 엄 마입니 다. 이 계정은 내   아들이 만들 었고 Tik Tok  계정을 가질 수  있는 나이 가 되지 않았으며 TikTok 커 뮤니티의 기준을 따르지 않 습니다.  소년 은 또한 사생활을  침해하고 Tik Tok 계정을 등록하기 위해 가짜 출 생 정보를 제공했습니 다. 이 계정 은 11세의 계정이며, 저는 어머 니로서 이 계정이 11세의 계정임을 확인합니다. TikTok 커뮤니  티 표준에 따라 자녀의 계정을  검토 하고 일 시 중지하 십시 오. Tiktok이  내   자녀의 계정을 정 지하기를 바랍니다. 감사  합니 다 틱톡!!!"
